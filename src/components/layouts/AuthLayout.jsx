...
import CRADE from "../../assets/images/chart.png";
      ...
      <div className='hidden md:block w-[40vw]  h-screen bg-violet-50 bg-auth-bg-img bg-cover    bg-no-repeat bg-center overflow-hidden p-8 relative '>
        ...
        <div className='grid grid-cols-1 z-20'>
          <StatusInfoCard
            ...
            lable="Track your Income & Expense"
            value="430,000"
            color="bg-primary"
...
const StatusInfoCard = ({ icon, lable, value, color }) => {
  return  <div className="flex gap-6 bg-white rounded-xl shadow-md shadow-purple-400/10 border border-gray-200/50 z-10">
